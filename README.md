...
**[Hello-rails-react]** is a web application that displays random greeting messages. Built with webpack, react and rails.
...
```sh
  ...
  git clone https://github.com/yetemegn-telaye/hello-rails-react.git
```
